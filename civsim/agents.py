...
Natively armored with catch-all kwargs signatures and registry object add parameters.
"""
import random
...
class Agent:
    def __init__(self, id, generation, x, y, **kwargs):
        ...
        # Armored to correctly flag individual resolution targets even under legacy LOW flags
        incoming_res = kwargs.get("resolution", Resolution.INDIVIDUAL)
        if incoming_res == Resolution.LOW:
            self.resolution = Resolution.INDIVIDUAL
        else:
            self.resolution = incoming_res
...
class AgentRegistry:
    ...
    def add_agent(self, agent) -> None:
        """FIX: Natively registers newborn agent instances generated by population math loops."""
