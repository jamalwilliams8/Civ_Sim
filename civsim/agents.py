...
Natively aligned to prevent resolution string/int mismatched ghost world leaks.
"""
import random
...
class Resolution:
    ...
    HIGH = 1
    LOW = 1  # Map LOW directly to INDIVIDUAL to unify high-res citizen loops
...
class Agent:
    def __init__(self, id, generation, x, y, **kwargs):
        ...
        # Unify resolution maps: both INDIVIDUAL and LOW are treated as high-res individual actors
        incoming_res = kwargs.get("resolution", Resolution.INDIVIDUAL)
        if incoming_res in [Resolution.INDIVIDUAL, Resolution.LOW]:
...
class AgentRegistry:
    ...
    def create_agent(self, generation, x, y, sex=None):
        ...
        # Starter generation 0 agents initialized as mature fertile adults (Ages 18-30)
    ...
    def add_agent(self, agent) -> None:
        """Natively registers newborn agent instances generated by population math loops."""
